...
parser.add_argument(
    "--correlator_dir",
    required=True,
    help="Directory containing correlation functions for a single ensemble",
)
parser.add_argument(
...
print(f"Processing: {args.correlator_dir}")

# Read the correlators for each channel
g5g5_correlators_array = read_g5g5(args.correlator_dir)
g0g5_correlators_array = read_g0g5(args.correlator_dir)
gi_correlators_array = read_gi(args.correlator_dir)
g0gi_correlators_array = read_g0gi(args.correlator_dir)
g5gi_correlators_array = read_g5gi(args.correlator_dir)
g0g5gi_correlators_array = read_g5gi(args.correlator_dir)
id_correlators_array = read_id(args.correlator_dir)
...
PJ5q_correlators_array = read_pj5q(args.correlator_dir)
...
file_pattern = os.path.join(args.correlator_dir, "pt_ll.[0-9]*.xml")
...
PCAC_correlators_array = read_pcac(args.correlator_dir)
...
g5g5_correlators_array = read_g0g5_g5(args.correlator_dir)
...
print(f"Results have been saved to {args.csv_file.name}.")
