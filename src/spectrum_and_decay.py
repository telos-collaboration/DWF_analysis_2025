...
with open(filename, mode="a", newline="") as file:
    ...
    subdirectories = [
        ...
        if os.path.isdir(os.path.join(parent_directory, sub))
    ]
    ...
    for subdirectory in sorted_subdirectories:
        ...
        eff_mass_g5g5, err_eff_mass_g5g5, eff_mass_extended_g5g5 = effective_mass(
            g5g5_correlators_array, time_extent
        )
        eff_mass_g0g5, err_eff_mass_g0g5, eff_mass_extended_g0g5 = effective_mass(
            g0g5_correlators_array, time_extent
        )
        eff_mass_gi, err_eff_mass_gi, eff_mass_extended_gi = effective_mass(
            gi_correlators_array, time_extent
        )
        eff_mass_g0gi, err_eff_mass_g0gi, eff_mass_extended_g0gi = effective_mass(
            g0gi_correlators_array, time_extent
        )
        eff_mass_g5gi, err_eff_mass_g5gi, eff_mass_extended_g5gi = effective_mass(
            g5gi_correlators_array, time_extent
        )
        eff_mass_g0g5gi, err_eff_mass_g0g5gi, eff_mass_extended_g0g5gi = effective_mass(
            g0g5gi_correlators_array, time_extent
        )
        eff_mass_id, err_eff_mass_id, eff_mass_extended_id = effective_mass(
        ...
        mean_plateau_g5g5, error_plateau_g5g5, _ = perform_correlated_fit(
        ...
        mean_plateau_g0g5, error_plateau_g0g5, _ = perform_correlated_fit(
        ...
        mean_plateau_gi, error_plateau_gi, _ = perform_correlated_fit(
        ...
        mean_plateau_g0gi, error_plateau_g0gi, _ = perform_correlated_fit(
        ...
        mean_plateau_g5gi, error_plateau_g5gi, _ = perform_correlated_fit(
        ...
        mean_plateau_g0g5gi, error_plateau_g0g5gi, _ = perform_correlated_fit(
        ...
        mean_plateau_id, error_plateau_id, _ = perform_correlated_fit(
        ...
        mres, err_mres = jackknife_effective_mass_block(
        ...
        covariance_matrix = np.cov(
            (PJ5q_correlators_array.T / g5g5_correlators_array.T).T
        )
        mean_plateau, error_plateau, _ = perform_correlated_fit(
        ...
        ZA, err_ZA, ZA_extended = jackknife_effective_mass_block_ZA(
        ...
        eff_mass, err_eff_mass, eff_mass_extended = effective_mass(
            g5g5_correlators_array, time_extent
        )
        ...
        if plateau:
            ...
            mean_plateau_ZA, error_plateau_ZA, chi_square = perform_correlated_fit(
