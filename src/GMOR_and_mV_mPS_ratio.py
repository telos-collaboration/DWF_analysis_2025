...
plots.add_output_arg(parser, "GMOR_mPS", "GMOR (w0m0 vs w0mPS)")
plots.add_output_arg(parser, "GMOR_fpi", "GMOR (w0m0 vs w0fpi)")
...
ax.fill_between(x_fit, y_fit_lower, y_fit_upper, color=CB_color_cycle[0], alpha=0.2)
