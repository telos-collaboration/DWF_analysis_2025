...
def read_g5g5(directory):
    ...
    for file_index, file_name in enumerate(file_list):
        ...
        for elem in root.findall('.//elem'):
            ...
            if gamma_snk_elem is not None and gamma_src_elem is not None \
...
def read_gi(directory):
    ...
    g5g5_correlators_array = (g5g5_correlators_array_X + g5g5_correlators_array_Y + g5g5_correlators_array_Z) / 3
    return g5g5_correlators_array
